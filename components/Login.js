...
const Login = () => {
  ...
  return (
    <View style={{ marginTop: 750, justifyContent: 'center', alignItems: 'center' }}>
      ...
      {/* Login */}
        <TouchableOpacity style={{ borderRadius: 16, backgroundColor: 'white', padding: 24, width: 312, borderWidth: 2, borderColor: 'black', marginTop: 20  }}onPress={()=>Navigator.navigate('Get Started1')}>
