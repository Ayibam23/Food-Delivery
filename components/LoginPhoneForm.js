...
const LoginPhoneForm = () => {
    ...
    return(
        ...
        <View style={{ marginVertical: 10 }}>
            <Text style={{ fontSize: 18, marginVertical: 8 }}>Phone number</Text>
            <View style={{ height: 43, borderColor: 'red', borderWidth: 1, borderRadius: 8, paddingLeft: 22 }}>
                <TextInput placeholder="Your Phone number" placeholderTextColor={'black'} keyboardType="default" style={{ width: 230, paddingVertical: 5 }}>
                </TextInput>
            </View>
        </View>
        <View style={{ marginVertical: 10 }}>
